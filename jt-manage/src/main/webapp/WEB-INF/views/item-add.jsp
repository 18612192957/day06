...
<div style="padding:10px 10px 10px 10px">
	<form id="itemAddForm" class="itemForm" method="post">
	    <table cellpadding="5">
	        ...
	        <tr>
	            <td>商品价格:</td>
	            <td><input class="easyui-numberbox" type="text" name="priceView" data-options="min:0.01,max:99999999,precision:2,required:true" />
...
<script type="text/javascript">
	...
	function submitForm(){
		...
		//转化价格单位，将元转化为分 val() 取值  赋值   eval()将字符串转化为js 对象/变量 var
